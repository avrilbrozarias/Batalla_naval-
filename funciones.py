            ...
            if validar_casilleros(matriz, fila_inicial, columna_inicial, lista_valor[i], orientacion) == True:
                ...
                for j in range(lista_valor[i]):
                    if orientacion == "H":
                        ...
                        bloque_barco = {"fila": fila_inicial, "columna": columna_inicial + j, "valor": lista_valor[i], "tocado": False, "hundido" : False }  # Guarda un bloque
                    else:
                        matriz[fila_inicial + j][columna_inicial] = lista_valor[i]
                        bloque_barco = {"fila": fila_inicial + j, "columna": columna_inicial, "valor": lista_valor[i], "tocado": False, "hundido" : False }  # Guarda un bloque
...
def gestionar_barcos_puntos(tablero:list, matriz_estado:list, lista_barcos:list)->int:
    '''
